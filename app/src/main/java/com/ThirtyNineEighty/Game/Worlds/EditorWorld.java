...
import com.ThirtyNineEighty.Renderable.Common.*;
  ...
  extends BaseWorld
{
  ...
  {
    currentObject = GameContext.factory.createObject(descriptionStr);
  ...
  public void apply()
  {
    ...
    // create new
    currentObject = GameContext.factory.createObject(description.getName());
